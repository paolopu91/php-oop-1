...
$Film1 = new Movie("Pirati Dei Caraibi", "Joachim Ronning", "Johnny Depp", "Orlando Bloom", 2003, "avventura");
...
echo '<h4>' . $Film1->getFullMovie() . '</h4>' ;
echo '<h4>' . $Film2->getFullMovie() . '</h4>' ;
echo '<h4>' . $Film3->getFullMovie() . '</h4>' ;
echo '<h4>' . $Film4->getFullMovie() . '</h4>' ;
